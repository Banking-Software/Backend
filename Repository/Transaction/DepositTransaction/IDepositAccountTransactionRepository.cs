...
namespace MicroFinance.Repository.Transaction
{
    public interface IDepositAccountTransactionRepository
    {
        ...
        Task<DepositAccount> BaseTransactionOnDepositAccount(DepositAccountTransactionWrapper depositAccountTransactionWrapper, BaseTransaction baseTransaction, TransactionTypeEnum subLedgerTransactionType);
