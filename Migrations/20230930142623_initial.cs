        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTax = table.Column<decimal>(type: "decimal(4,2)", precision: 4, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PriceOfOneKitta = table.Column<int>(type: "int", precision: 5, scale: 2, nullable: false),
                    CurrentKitta = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionVouchers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BranchCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TotalInterestBalance = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientDateOfBirth = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ClientCitizenShipIssueDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Transactions_TransactionVouchers_VoucherId",
                        column: x => x.VoucherId,
                        principalTable: "TransactionVouchers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentShareBalance = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NepaliMatureDate = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EnglishMatureDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    NextInterestPostingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PreviousInterestPostedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    InterestRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CalculatedInterestRate = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false),
                    CalculatedInterestAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsInterestPosted = table.Column<bool>(type: "bit", nullable: false),
                    DepositAccountId = table.Column<int>(type: "int", nullable: false),
                    TransactionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InterestTransactions_DepositAccounts_DepositAccountId",
                        column: x => x.DepositAccountId,
                        principalTable: "DepositAccounts",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterestTransactions_DepositAccountId",
                table: "InterestTransactions",
                column: "DepositAccountId");

            migrationBuilder.CreateIndex(
                name: "IX_InterestTransactions_Id",
                table: "InterestTransactions",
                column: "Id");

            migrationBuilder.CreateIndex(
                name: "IX_InterestTransactions_TransactionId",
                table: "InterestTransactions",
                column: "TransactionId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionVouchers_VoucherNumber",
                table: "TransactionVouchers",
