...
namespace MicroFinance.Migrations.Application
{
    ...
    [Migration("20230807121158_Share Transaction1.0")]
    partial class ShareTransaction10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MicroFinance.Models.Share.ShareAccount", b =>
                {
                    ...
                    b.HasIndex("ClientId1")
                        .IsUnique()
                        .HasFilter("[ClientId1] IS NOT NULL");
            ...
            modelBuilder.Entity("MicroFinance.Models.Share.ShareAccount", b =>
                {
                    ...
                    b.HasOne("MicroFinance.Models.ClientSetup.Client", null)
                        .WithOne("ShareAccount")
                        .HasForeignKey("MicroFinance.Models.Share.ShareAccount", "ClientId1");
